...
class _UserProfilePageState extends State<UserProfilePage> {
                  ...
                  children: [
                      ...
                      child: Container(
                        ...
                        child: BlocBuilder<UserProfileCubit, UserProfileState>(
                          builder: (context, state) {
                            final data = state is UserProfileSuccess
                                ? state.data
                                : null;
                            return Row(
                    ...
                    Padding(
                      ...
                      child: AppSegmentedControl(
                        ...
                        items: [
                          'drawer.settings'.tr(),
                          'home.specialist_role'
                              .tr(), // "يوم الرشاقة" / Fitness Day
                        ],
      ...
      _buildMenuItem(
        ...
        onTap: () {
          showDialog(
            ...
            barrierColor: AppColors.scrimOverlay.withValues(alpha: 0.5),
            builder: (context) =>
                ChangePhoneDialog(initialPhone: data?.identifier),
          );
        },
      ),
    _buildMenuItem(
  ...
  Widget _buildCircleIcon({
    ...
    return Center(
      child: iconPath != null
          ? AppImage(iconPath, width: 40.r, height: 40.r)
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: AppColors.dividerLight, width: 0.2.w),
          boxShadow: AppShadows.profileItemShadow,
        ),
        child: Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
